...
- **实战专栏**（`/lab/`）：动手做一个 mini Agent——零依赖纯 Node.js，5 关从裸 fetch 到工具循环、流式事件、上下文压缩、可交互 REPL，每关对照 Pi 源码；配套代码已开源在 [pi-mini-agent](https://github.com/zhoujianbin/pi-mini-agent)，5 关全部用真实 API 实测通过
